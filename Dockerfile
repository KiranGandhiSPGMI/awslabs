...
# Copy our code from the "/src/YoDotNetCoreApp/bin/Debug/netcoreapp1.1/publish" folder to the "/app" folder in our container
WORKDIR /app
...
ENTRYPOINT ["dotnet", "YoDotNetCoreApp.dll"]